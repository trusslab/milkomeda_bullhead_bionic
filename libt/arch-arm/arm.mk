...
libt_arch_static_src_files_arm := arch-arm/bionic/exidx_static.c
libt_arch_dynamic_src_files_arm := arch-arm/bionic/exidx_dynamic.c
...
libt_common_additional_dependencies += $(cpu_variant_mk)

cpu_variant_mk :=
endif


libt_crt_target_cflags_arm := \
    -I$(LOCAL_PATH)/arch-arm/include \
    -mthumb-interwork

libt_crt_target_so_cflags_arm :=

libt_crt_target_crtbegin_file_arm := \
    $(LOCAL_PATH)/arch-common/bionic/crtbegin.c

libt_crt_target_crtbegin_so_file_arm := \
