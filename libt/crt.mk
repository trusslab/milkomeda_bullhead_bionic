# Define the libt run-time (crt) support object files that must be built,
...
my_libt_crt_target_crtbegin_file := $(libt_crt_target_crtbegin_file_$(my_arch))
my_libt_crt_target_crtbegin_so_file := $(libt_crt_target_crtbegin_so_file_$(my_arch))

my_libt_crt_target_cflags := \
    $(libt_crt_target_cflags) \
    $(libt_crt_target_cflags_$(my_arch))

my_libt_crt_target_so_cflags := \
    $(libt_crt_target_so_cflags_$(my_arch)) \
    $(my_libt_crt_target_cflags)

my_libt_crt_target_ldflags := $(libt_crt_target_ldflags_$(my_arch))
...
$(GEN): PRIVATE_CFLAGS := $(my_libt_crt_target_so_cflags)
...
$(GEN): PRIVATE_CC := $($(my_2nd_arch_prefix)TARGET_CC)
$(GEN): PRIVATE_CFLAGS := $(my_libt_crt_target_so_cflags)
$(GEN): $(my_libt_crt_target_crtbegin_so_file)
	@mkdir -p $(dir $@)
	$(hide) $(PRIVATE_CC) $(PRIVATE_CFLAGS) \
		-MD -MF $(@:%.o=%.d) -o $@ -c $<
	$(transform-d-to-p)
...
$(GEN): PRIVATE_LDFLAGS := $(my_libt_crt_target_ldflags)
$(GEN): $($(my_2nd_arch_prefix)TARGET_OUT_INTERMEDIATE_LIBRARIES)/crtbegin_so1.o \
...
$(GEN): PRIVATE_CC := $($(my_2nd_arch_prefix)TARGET_CC)
$(GEN): PRIVATE_CFLAGS := $(my_libt_crt_target_cflags)
$(GEN): $(my_libt_crt_target_crtbegin_file)
	@mkdir -p $(dir $@)
	$(hide) $(PRIVATE_CC) $(PRIVATE_CFLAGS) \
		-MD -MF $(@:%.o=%.d) -o $@ -c $<
	$(transform-d-to-p)
...
# Clear temp vars
my_libt_crt_target_ldflags :=
my_libt_crt_target_so_cflags :=
my_libt_crt_target_cflags :=
my_libt_crt_target_crtbegin_so_file :=
my_libt_crt_target_crtbegin_file :=
my_arch :=
