...
libt_common_additional_dependencies := $(LOCAL_PATH)/Android.mk

# Load config for TARGET_ARCH
my_2nd_arch_prefix :=
include $(LOCAL_PATH)/arch-$(TARGET_ARCH)/$(TARGET_ARCH).mk
libt_common_additional_dependencies += \
...
# Define the common source files for all the libt instances
# =========================================================
libt_common_src_files := \
    bionic/ether_aton.c \
    bionic/ether_ntoa.c \
    bionic/fts.c \
...
# Fortify implementations of libt functions.
libt_common_src_files += \
    bionic/__FD_chk.cpp \
...
# The data that backs getauxval is initialized in the libt init functions which
# are invoked by the linker. If this file is included in libt_ndk.a, only one of
# the copies of the global data will be initialized, resulting in nullptr
# dereferences.
libt_bionic_src_files += bionic/getauxval.cpp

# These four require getauxval, which isn't available on older platforms.
libt_bionic_src_files += bionic/getentropy_linux.c
libt_bionic_src_files += bionic/sysconf.cpp
libt_bionic_src_files += bionic/vdso.cpp
libt_bionic_src_files += bionic/setjmp_cookie.cpp
...
libt_upstream_freebsd_src_files := \
...
libt_upstream_netbsd_src_files := \
...
libt_upstream_openbsd_gdtoa_src_files := \
...
libt_upstream_openbsd_gdtoa_src_files_32 := \
    $(libt_upstream_openbsd_gdtoa_src_files) \

libt_upstream_openbsd_gdtoa_src_files_64 := \
    $(libt_upstream_openbsd_gdtoa_src_files) \
    upstream-openbsd/lib/libc/gdtoa/strtorQ.c \

# These two depend on getentropy_linux.c, which isn't in libt_ndk.a.
libt_upstream_openbsd_src_files := \
...
libt_upstream_openbsd_ndk_src_files := \
...
libt_bionic_ndk_src_files_32 += \
    bionic/mmap.cpp \

libt_common_src_files_32 += \
    bionic/legacy_32_bit_support.cpp \
    bionic/time64.c \

libt_netbsd_src_files_32 += \
    upstream-netbsd/common/lib/libc/hash/sha1/sha1.c \

libt_openbsd_src_files_32 += \
...
# b/25291096, Clang/llvm compiled libt.so for mips/mips64 failed to boot.
...
ifeq ($(strip $(DEBUG_BIONIC_LIBC)),true)
  libt_common_cflags += -DDEBUG
endif

libt_malloc_src := bionic/jemalloc_wrapper.cpp
libt_common_c_includes += external/jemalloc/include

ifeq ($(BOARD_USES_LEGACY_MMAP),true)
  libt_common_cflags += -DLEGACY_MMAP
endif

# Define some common conlyflags
libt_common_conlyflags := \
    -std=gnu99

# Define some common cppflags
libt_common_cppflags := \

# Define some common includes
# ========================================================
libt_common_c_includes += \
    $(LOCAL_PATH)/stdio   \
...
# ========================================================
# libt_stack_protector.a - stack protector code
# ========================================================
#
...
LOCAL_CFLAGS := $(libt_common_cflags) -fno-stack-protector
LOCAL_CONLYFLAGS := $(libt_common_conlyflags)
LOCAL_CPPFLAGS := $(libt_common_cppflags)
LOCAL_C_INCLUDES := $(libt_common_c_includes)
LOCAL_MODULE := libt_stack_protector
LOCAL_CLANG := $(use_clang)
LOCAL_ADDITIONAL_DEPENDENCIES := $(libt_common_additional_dependencies)
LOCAL_CXX_STL := none
LOCAL_SYSTEM_SHARED_LIBRARIES :=
LOCAL_SANITIZE := never
LOCAL_NATIVE_COVERAGE := $(bionic_coverage)

$(eval $(call patch-up-arch-specific-flags,LOCAL_CFLAGS,libt_common_cflags))
include $(BUILD_STATIC_LIBRARY)


# libt_init_static.cpp also needs to be built without stack protector,
...
# ========================================================
# libt_tzcode.a - upstream 'tzcode' code
# ========================================================
...
LOCAL_CFLAGS := $(libt_common_cflags) \
    -fvisibility=hidden \
...
LOCAL_CONLYFLAGS := $(libt_common_conlyflags)
LOCAL_CPPFLAGS := $(libt_common_cppflags)
LOCAL_C_INCLUDES := $(libt_common_c_includes) $(LOCAL_PATH)/tzcode/
LOCAL_MODULE := libt_tzcode
LOCAL_CLANG := $(use_clang)
LOCAL_ADDITIONAL_DEPENDENCIES := $(libt_common_additional_dependencies)
LOCAL_CXX_STL := none
LOCAL_SYSTEM_SHARED_LIBRARIES :=
...
# ========================================================
# libt_dns.a - modified NetBSD DNS code
# ========================================================
...
# ========================================================
# libt_freebsd.a - upstream FreeBSD C library code
# ========================================================
#
...
LOCAL_SRC_FILES := $(libt_upstream_freebsd_src_files)
LOCAL_CFLAGS := \
    $(libt_common_cflags) \
...
$(eval $(call patch-up-arch-specific-flags,LOCAL_CFLAGS,libt_common_cflags))
$(eval $(call patch-up-arch-specific-flags,LOCAL_SRC_FILES_EXCLUDE,libt_freebsd_src_files_exclude))
include $(BUILD_STATIC_LIBRARY)


# ========================================================
# libt_netbsd.a - upstream NetBSD C library code
# ========================================================
#
...
LOCAL_SRC_FILES := $(libt_upstream_netbsd_src_files)
LOCAL_CFLAGS := \
    $(libt_common_cflags) \
    -Wno-sign-compare \
    -Wno-uninitialized \
...
$(eval $(call patch-up-arch-specific-flags,LOCAL_CFLAGS,libt_common_cflags))
$(eval $(call patch-up-arch-specific-flags,LOCAL_SRC_FILES,libt_netbsd_src_files))
include $(BUILD_STATIC_LIBRARY)


# ========================================================
# libt_openbsd_ndk.a - upstream OpenBSD C library code
# that can be safely included in the libt_ndk.a (doesn't
...
LOCAL_SRC_FILES := $(libt_upstream_openbsd_ndk_src_files)
LOCAL_CLANG := $(use_clang)
...
# ========================================================
# libt_openbsd.a - upstream OpenBSD C library code
# ========================================================
#
# These files are built with the openbsd-compat.h header file
# automatically included.
...
LOCAL_SRC_FILES := $(libt_upstream_openbsd_src_files)
LOCAL_CLANG := $(use_clang)
...
$(eval $(call patch-up-arch-specific-flags,LOCAL_CFLAGS,libt_common_cflags))
$(eval $(call patch-up-arch-specific-flags,LOCAL_SRC_FILES,libt_openbsd_src_files))
$(eval $(call patch-up-arch-specific-flags,LOCAL_SRC_FILES_EXCLUDE,libt_openbsd_src_files_exclude))
include $(BUILD_STATIC_LIBRARY)


# ========================================================
# libt_gdtoa.a - upstream OpenBSD C library gdtoa code
# ========================================================
#
# These files are built with the openbsd-compat.h header file
# automatically included.
...
LOCAL_SRC_FILES_32 := $(libt_upstream_openbsd_gdtoa_src_files_32)
LOCAL_SRC_FILES_64 := $(libt_upstream_openbsd_gdtoa_src_files_64)
LOCAL_CLANG := $(use_clang)
...
# ========================================================
# libt_bionic.a - home-grown C library code
# ========================================================

include $(CLEAR_VARS)

LOCAL_SRC_FILES := $(libt_bionic_src_files)
LOCAL_CFLAGS := $(libt_common_cflags) \
    -Wframe-larger-than=2048 \

LOCAL_CONLYFLAGS := $(libt_common_conlyflags)
LOCAL_CPPFLAGS := $(libt_common_cppflags) -Wold-style-cast
LOCAL_C_INCLUDES := $(libt_common_c_includes) bionic/libstdc++/include
LOCAL_MODULE := libt_bionic
LOCAL_CLANG := $(use_clang)
LOCAL_ADDITIONAL_DEPENDENCIES := $(libt_common_additional_dependencies)
LOCAL_CXX_STL := none
LOCAL_SYSTEM_SHARED_LIBRARIES :=
...
$(eval $(call patch-up-arch-specific-flags,LOCAL_CFLAGS,libt_common_cflags))
$(eval $(call patch-up-arch-specific-flags,LOCAL_SRC_FILES,libt_bionic_src_files))
$(eval $(call patch-up-arch-specific-flags,LOCAL_SRC_FILES_EXCLUDE,libt_bionic_src_files_exclude))
include $(BUILD_STATIC_LIBRARY)


# ========================================================
# libt_bionic_ndk.a - The portions of libt_bionic that can
# be safely used in libt_ndk.a (no troublesome global data
# or constructors).
# ========================================================

include $(CLEAR_VARS)

LOCAL_SRC_FILES := $(libt_bionic_ndk_src_files)
LOCAL_CFLAGS := $(libt_common_cflags) \
    -Wframe-larger-than=2048 \
...
$(eval $(call patch-up-arch-specific-flags,LOCAL_CFLAGS,libt_common_cflags))
$(eval $(call patch-up-arch-specific-flags,LOCAL_SRC_FILES,libt_bionic_ndk_src_files))
include $(BUILD_STATIC_LIBRARY)


# ========================================================
# libt_pthread.a - pthreads parts that previously lived in
# libt_bionic.a. Relocated to their own library because
# they can't be included in libt_ndk.a (as they layout of
...
LOCAL_SRC_FILES := $(libt_pthread_src_files)
LOCAL_CFLAGS := $(libt_common_cflags) \
    -Wframe-larger-than=2048 \
...
# ========================================================
# libt_cxa.a - Things traditionally in libstdc++_secure
# ========================================================

include $(CLEAR_VARS)

LOCAL_SRC_FILES := $(libt_cxa_src_files)
LOCAL_CFLAGS := $(libt_common_cflags) \
    -fvisibility=hidden \
...
LOCAL_MODULE := libt_aeabi
LOCAL_CLANG := $(use_clang)
LOCAL_CFLAGS := $(libt_common_cflags) -fno-builtin
LOCAL_ADDITIONAL_DEPENDENCIES := $(libt_common_additional_dependencies)
LOCAL_CXX_STL := none
LOCAL_SYSTEM_SHARED_LIBRARIES :=
LOCAL_SANITIZE := never
...
# all the parts of libt that are safe to statically link.
...
LOCAL_MODULE := libt_ndk
LOCAL_CLANG := $(use_clang)
LOCAL_ASFLAGS := $(LOCAL_CFLAGS)
LOCAL_CONLYFLAGS := $(libt_common_conlyflags)
LOCAL_CFLAGS := $(libt_common_cflags) -fvisibility=hidden -O0
LOCAL_CPPFLAGS := $(libt_common_cppflags)
LOCAL_C_INCLUDES := $(libt_common_c_includes)
LOCAL_SANITIZE := never
LOCAL_NATIVE_COVERAGE := $(bionic_coverage)
...
LOCAL_SRC_FILES := \
    $(libt_common_src_files) \
    $(libt_arch_dynamic_src_files) \
    $(libt_ndk_stub_src_files) \
...
LOCAL_WHOLE_STATIC_LIBRARIES := \
    ...
    libt_netbsd \
    libt_openbsd_ndk \
    libt_stack_protector \
    libt_syscalls \
    libt_tzcode \
    libm \
    libjemalloc \

LOCAL_WHOLE_STATIC_LIBRARIES_arm := libt_aeabi
LOCAL_CXX_STL := none

$(eval $(call patch-up-arch-specific-flags,LOCAL_CFLAGS,libt_common_cflags))
$(eval $(call patch-up-arch-specific-flags,LOCAL_SRC_FILES,libt_common_src_files))
$(eval $(call patch-up-arch-specific-flags,LOCAL_SRC_FILES,libt_arch_dynamic_src_files))
...
LOCAL_SRC_FILES := $(libt_common_src_files)
LOCAL_CFLAGS := $(libt_common_cflags)
LOCAL_CONLYFLAGS := $(libt_common_conlyflags)
LOCAL_CPPFLAGS := $(libt_common_cppflags)
LOCAL_C_INCLUDES := $(libt_common_c_includes)
LOCAL_MODULE := libt_common
LOCAL_CLANG := $(use_clang)
LOCAL_ADDITIONAL_DEPENDENCIES := $(libt_common_additional_dependencies)
LOCAL_WHOLE_STATIC_LIBRARIES := \
    libt_bionic \
...
LOCAL_MODULE := libt_nomalloc
LOCAL_CLANG := $(use_clang)
LOCAL_ADDITIONAL_DEPENDENCIES := $(libt_common_additional_dependencies)
LOCAL_WHOLE_STATIC_LIBRARIES := libt_common libt_init_static
LOCAL_CXX_STL := none
LOCAL_SYSTEM_SHARED_LIBRARIES :=
LOCAL_SANITIZE := never
LOCAL_NATIVE_COVERAGE := $(bionic_coverage)
...
$(eval $(call patch-up-arch-specific-flags,LOCAL_CFLAGS,libt_common_cflags))
$(eval $(call patch-up-arch-specific-flags,LOCAL_SRC_FILES,libt_arch_static_src_files))
include $(BUILD_STATIC_LIBRARY)


# ========================================================
# libt_malloc.a: the _prefixed_ malloc functions (like dlcalloc).
# ========================================================

include $(CLEAR_VARS)
LOCAL_SRC_FILES := $(libt_malloc_src)
LOCAL_CFLAGS := $(libt_common_cflags) \
    -fvisibility=hidden \
...
LOCAL_CLANG := $(use_clang)
LOCAL_ADDITIONAL_DEPENDENCIES := $(libt_common_additional_dependencies)
LOCAL_WHOLE_STATIC_LIBRARIES := libt_common libt_init_static libjemalloc
...
# Do not pack libt.so relocations; see http://b/20645321 for details.
LOCAL_PACK_MODULE_RELOCATIONS := false

# WARNING: The only library libt.so should depend on is libdl.so!  If you add other libraries,
# make sure to add -Wl,--exclude-libs=libgcc.a to the LOCAL_LDFLAGS for those libraries.  This
# ensures that symbols that are pulled into those new libraries from libgcc.a are not declared
# external; if that were the case, then libt would not pull those symbols from libgcc.a as it
# should, instead relying on the external symbols from the dependent libraries.  That would
# create a "cloaked" dependency on libgcc.a in libt though the libraries, which is not what
# you wanted!

LOCAL_SHARED_LIBRARIES := libdl
LOCAL_WHOLE_STATIC_LIBRARIES := libt_common libjemalloc
...
LOCAL_NO_CRT := true
LOCAL_ASFLAGS += $(libt_crt_target_cflags)
...
LOCAL_MODULE:= libstdc++_secure
LOCAL_ADDITIONAL_DEPENDENCIES := $(LOCAL_PATH)/Android.mk
LOCAL_CXX_STL := none
LOCAL_SYSTEM_SHARED_LIBRARIES := libt
LOCAL_STATIC_LIBRARIES := libt_logging
LOCAL_SANITIZE := never
LOCAL_NATIVE_COVERAGE := $(bionic_coverage)
include $(BUILD_SHARED_LIBRARY)
