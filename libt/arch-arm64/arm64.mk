...
libt_bionic_src_files_exclude_arm64 += \
    bionic/__memcpy_chk.cpp \
    bionic/strchr.cpp \
    bionic/strnlen.c \
    bionic/strrchr.cpp \

libt_freebsd_src_files_exclude_arm64 += \
    upstream-freebsd/lib/libc/string/wmemmove.c \

libt_openbsd_src_files_exclude_arm64 += \
...
libt_crt_target_cflags_arm64 := \
    -I$(LOCAL_PATH)/arch-arm64/include

libt_crt_target_crtbegin_file_arm64 := \
    $(LOCAL_PATH)/arch-arm64/bionic/crtbegin.c

libt_crt_target_crtbegin_so_file_arm64 := \
